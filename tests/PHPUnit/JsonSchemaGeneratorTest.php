...
final class JsonSchemaGeneratorTest extends TestCase
{
    ...
    public static function fromClass_dataProvider(): Generator
    {
        ...
        yield 'integer based object' => ['className' => Fixture\Age::class, 'expectedResult' => '{"type":"integer","description":"The age of a person in years","examples":[33,66],"minimum":1,"maximum":120}'];
        yield 'list object' => ['className' => Fixture\FullNames::class, 'expectedResult' => '{"type":"array","items":{"type":"object","description":"First and last name of a person","properties":{"givenName":{"type":"string","description":"Overridden given name description","examples":["Jane","John"],"minLength":3,"maxLength":20},"familyName":{"type":"string","description":"Last name of a person","minLength":3,"maxLength":20}},"additionalProperties":false,"required":["givenName","familyName"]},"minItems":2,"maxItems":5}'];
        yield 'shape object' => ['className' => Fixture\FullName::class, 'expectedResult' => '{"type":"object","description":"First and last name of a person","properties":{"givenName":{"type":"string","description":"Overridden given name description","examples":["Jane","John"],"minLength":3,"maxLength":20},"familyName":{"type":"string","description":"Last name of a person","minLength":3,"maxLength":20}},"additionalProperties":false,"required":["givenName","familyName"]}'];
        ...
        yield 'string based object' => ['className' => Fixture\GivenName::class, 'expectedResult' => '{"type":"string","description":"First name of a person","examples":["Jane","John"],"minLength":3,"maxLength":20}'];
        ...
        yield 'shape with floats' => ['className' => Fixture\GeoCoordinates::class, 'expectedResult' => '{"type":"object","properties":{"longitude":{"type":"number","minimum":-180,"maximum":180.5,"examples":[77.0368]},"latitude":{"type":"number","minimum":-90,"maximum":90}},"additionalProperties":false,"required":["longitude","latitude"]}'];
        yield 'shape with discriminated union type' => ['className' => Fixture\SomeShapeWithDiscriminatedUnionType::class, 'expectedResult' => '{"additionalProperties":false,"properties":{"name":{"oneOf":[{"description":"First name of a person","examples":["Jane","John"],"maxLength":20,"minLength":3,"type":"string"},{"description":"Last name of a person","maxLength":20,"minLength":3,"type":"string"}]}},"required":["name"],"type":"object"}'];
        yield 'shape with interface property' => ['className' => Fixture\SomeShapeWithInterfaceProperty::class, 'expectedResult' => '{"additionalProperties":false,"properties":{"property":{"oneOf":[{"description":"First name of a person","examples":["Jane","John"],"maxLength":20,"minLength":3,"type":"string"},{"description":"Last name of a person","maxLength":20,"minLength":3,"type":"string"}]}},"required":["property"],"type":"object"}'];

        yield 'interface' => ['className' => Fixture\SomeInterface::class, 'expectedResult' => '{"oneOf":[{"description":"First name of a person","examples":["Jane","John"],"maxLength":20,"minLength":3,"type":"string"},{"description":"Last name of a person","maxLength":20,"minLength":3,"type":"string"},{"additionalProperties":false,"description":"First and last name of a person","properties":{"familyName":{"description":"Last name of a person","maxLength":20,"minLength":3,"type":"string"},"givenName":{"description":"Overridden given name description","examples":["Jane","John"],"maxLength":20,"minLength":3,"type":"string"}},"required":["givenName","familyName"],"type":"object"}]}'];
        yield 'interface with discriminator' => ['className' => Fixture\SomeInterfaceWithDiscriminator::class, 'expectedResult' => '{"oneOf":[{"description":"First name of a person","examples":["Jane","John"],"maxLength":20,"minLength":3,"type":"string"},{"description":"Last name of a person","maxLength":20,"minLength":3,"type":"string"}]}'];
    ...
    {
        yield 'shape with discriminated union type' => ['className' => Fixture\SomeShapeWithDiscriminatedUnionType::class, 'expectedResult' => '{"additionalProperties":false,"properties":{"name":{"discriminator":{"mapping":{"f":"Wwwision\\\\TypesJsonSchema\\\\Tests\\\\PHPUnit\\\\Fixture\\\\FamilyName","g":"Wwwision\\\\TypesJsonSchema\\\\Tests\\\\PHPUnit\\\\Fixture\\\\GivenName"},"propertyName":"t"},"oneOf":[{"description":"First name of a person","examples":["Jane","John"],"maxLength":20,"minLength":3,"type":"string"},{"description":"Last name of a person","maxLength":20,"minLength":3,"type":"string"}]}},"required":["name"],"type":"object"}'];
        yield 'shape with interface property' => ['className' => Fixture\SomeShapeWithInterfaceProperty::class, 'expectedResult' => '{"additionalProperties":false,"properties":{"property":{"discriminator":{"mapping":{"family":"Wwwision\\\\TypesJsonSchema\\\\Tests\\\\PHPUnit\\\\Fixture\\\\FamilyName","given":"Wwwision\\\\TypesJsonSchema\\\\Tests\\\\PHPUnit\\\\Fixture\\\\GivenName"},"propertyName":"type"},"oneOf":[{"description":"First name of a person","examples":["Jane","John"],"maxLength":20,"minLength":3,"type":"string"},{"description":"Last name of a person","maxLength":20,"minLength":3,"type":"string"}]}},"required":["property"],"type":"object"}'];

        yield 'interface' => ['className' => Fixture\SomeInterface::class, 'expectedResult' => '{"oneOf":[{"description":"First name of a person","examples":["Jane","John"],"maxLength":20,"minLength":3,"type":"string"},{"description":"Last name of a person","maxLength":20,"minLength":3,"type":"string"},{"additionalProperties":false,"description":"First and last name of a person","properties":{"familyName":{"description":"Last name of a person","maxLength":20,"minLength":3,"type":"string"},"givenName":{"description":"Overridden given name description","examples":["Jane","John"],"maxLength":20,"minLength":3,"type":"string"}},"required":["givenName","familyName"],"type":"object"}]}'];
        yield 'interface with discriminator' => ['className' => Fixture\SomeInterfaceWithDiscriminator::class, 'expectedResult' => '{"discriminator":{"mapping":{"family":"Wwwision\\\\TypesJsonSchema\\\\Tests\\\\PHPUnit\\\\Fixture\\\\FamilyName","given":"Wwwision\\\\TypesJsonSchema\\\\Tests\\\\PHPUnit\\\\Fixture\\\\GivenName"},"propertyName":"type"},"oneOf":[{"description":"First name of a person","examples":["Jane","John"],"maxLength":20,"minLength":3,"type":"string"},{"description":"Last name of a person","maxLength":20,"minLength":3,"type":"string"}]}'];
    }
    ...
    public static function fromReflectionParameter_dataProvider(): Generator
    {
        ...
        yield 'string based' => ['reflectionParameter' => new ReflectionParameter(fn(Fixture\GivenName $param) => null, 0), 'expectedResult' => '{"type":"string","description":"First name of a person","examples":["Jane","John"],"minLength":3,"maxLength":20}'];
        yield 'string based with custom description' => ['reflectionParameter' => new ReflectionParameter(fn(#[Description('some overridden description')] Fixture\GivenName $param) => null, 0), 'expectedResult' => '{"type":"string","description":"some overridden description","examples":["Jane","John"],"minLength":3,"maxLength":20}'];
